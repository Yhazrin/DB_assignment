...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                ...
                <a href="${pageContext.request.contextPath}/compare.jsp" class="btn secondary">Start Comparing</a>
            </div>
        </div>
    ...
    <section class="section-compare">
        <div class="section-container">
            ...
            <div class="section-content">
                ...
                <p>Select up to 5 phones for detailed specification comparison. Find the strengths and weaknesses across multiple dimensions to make the best choice for your needs.</p>
                <ul class="feature-list">
        ...
        <div class="section-container">
            <div class="section-content">
                ...
                <ul class="feature-list">
                    ...
                    <li><i class="fas fa-check-circle"></i> Purchase advice and Q&A</li>
    ...
    <section class="cta-section">
        ...
        <div class="cta-buttons">
            <a href="${pageContext.request.contextPath}/overview.jsp" class="btn primary">Browse Phone Database</a>
