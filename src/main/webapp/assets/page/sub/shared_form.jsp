...
<div class="console-container">
    <div class="console-card">
        ...
        <form class="console-form"
            ...
            <% boolean isDelete = "delete".equals(mode); %>

            <div class="form-group">
                <label for="model">Model</label>
                <input type="text" name="model" id="model" <%= isDelete ? "required" : "" %>>
            </div>
            ...
            <button type="submit" class="console-btn color-btn"><%= buttonText %></button>
        </form>
    </div>
</div>
